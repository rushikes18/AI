...
function Home() {
  ...
  // Guard: If userData is not loaded yet, show nothing or a loader
  ...
  useEffect(() => {
    ...
    const greeting = new window.SpeechSynthesisUtterance(`Hello ${userData.name}, what can I help you with?`);
    greeting.lang = 'hi-IN';
